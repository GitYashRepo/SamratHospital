...
const Navbar = () => {
   ...
   return (
      <header className="w-full pb-20 sm:pb-0">
         {/* Top Bar - Contact Info */}
         <div style={{ background: "linear-gradient(to right, #1E3A5F, #2B4A6F)" }} className="text-white">
            <div className="container mx-auto px-6">
               <div className="flex items-center justify-between h-9 text-xs">
                  <div className="flex items-center gap-6">
                     <a href="tel:+1234567890" className="flex items-center gap-1.5 hover:text-[#7DD3C0] transition-colors">
         ...
         <div
            ...
            className="border-b border-gray-100 sticky top-0 z-50"
         >
            <div className="container mx-auto px-6">
               <div className="flex items-center justify-between h-16">
                  {/* Logo */}
                  ...
                  <nav className="hidden lg:flex items-center gap-8">
                     ...
                     <div className="relative group">
                        ...
                        <div
                           onMouseEnter={() => setAboutDropdownOpen(true)}
                           onMouseLeave={() => setAboutDropdownOpen(false)}
                           className={`absolute left-0 mt-0 w-48 bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden transform transition-all duration-200 origin-top ${aboutDropdownOpen ? "opacity-100 scale-y-100 visible" : "opacity-0 scale-y-95 invisible"
                              }`}
                        >
                           <a
                              href="/about"
                     ...
                     <div className="relative group">
                        ...
                        <div
                           onMouseEnter={() => setServicesDropdownOpen(true)}
                           onMouseLeave={() => setServicesDropdownOpen(false)}
                           className={`absolute left-0 mt-0 w-56 bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden transform transition-all duration-200 origin-top ${servicesDropdownOpen ? "opacity-100 scale-y-100 visible" : "opacity-0 scale-y-95 invisible"
                              }`}
                        >
                           <a
                              href="#"
